...
kubectl delete -f ./ingress-routes/papi-svcs-ingress.yaml -n papi
...
kubectl create -f ./ingress-routes/papi-svcs-ingress.yaml -n papi
...
kubectl delete -f ./ingress-routes/ds-svcs-ingress.yaml -n datascience
...
kubectl create -f ./ingress-routes/ds-svcs-ingress.yaml -n datascience
